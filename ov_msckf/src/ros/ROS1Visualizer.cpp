...
void ROS1Visualizer::setup_subscribers(std::shared_ptr<ov_core::YamlParser> parser) {
  ...
  _nh->param<std::string>("topic_imu", topic_imu, "/leap/ins570_imu");
  ...
  if (_app->get_params().state_options.num_cameras == 2) {
    ...
    _nh->param<std::string>("topic_camera" + std::to_string(0), cam_topic0,  "/leap/sensor/multicamera/image");
    _nh->param<std::string>("topic_camera" + std::to_string(1), cam_topic1, "/leap/sensor/multicamera/image");
