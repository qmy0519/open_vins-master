...
int main(int argc, char **argv) {
  ...
  nh->param<std::string>("topic_camera0", topic_camera0, "/leap/sensor/multicamera/image");
  nh->param<std::string>("topic_camera1", topic_camera1, "/leap/sensor/multicamera/image");
